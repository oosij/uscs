...
from US_News_other_func import barchart_commdities_table_info, barchart_news_crawler, etf_symbols_load
...
## 이 메인 함수는 ETF/원자재 구분이 명확하지 않아, 임의로 Barchart 뉴스를 기반으로 수집시, 20개 만 가능하도록 진행하였음.
